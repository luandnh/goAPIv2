...
// error_reporting(E_ALL);
	...
	$VARDB_server   = (!isset($VARDB_server)) ? "tlink01.tel4vn.com" : $VARDB_server;
	...
	$VARDBgo_server   = (!isset($VARDBgo_server)) ? "tlink01.tel4vn.com" : $VARDBgo_server;
	...
	$VARDBgokam_server   = (!isset($VARDBgokam_server)) ? "tlink01.tel4vn.com" : $VARDBgokam_server;
    ...
    $checkLogPass    = (isset($_REQUEST['log_pass']) ? true : false);
